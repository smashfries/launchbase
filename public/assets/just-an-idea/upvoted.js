  ...
  headers: {
    ...
    .then((data) => {
      if (data.error) {
        ...
        const ideas = data.hottestIdeas;
        if (ideas.length == 0) {
          draftContainer.innerHTML = '<p>No upvoted ideas to display! ' +
          'Click <a style="margin:0" href="/just-an-idea"><u>here</u></a>' +
          ' to here to view some amazing ideas posted by the Community.' +
          ' If you like some of them, upvote them to share your support ' +
          'with their creators. It will show up here once you have' +
          ' upovted them.</p>';
        }
        ideas.forEach((idea) => {
          addIdeaItems(idea);
